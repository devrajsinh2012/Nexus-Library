            ...
            >
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                {isAuthenticated ? (
                  ...
                  <>
                    <Button size="lg" className="rounded-full h-14 px-8 text-base bg-primary hover:bg-primary/90 shadow-xl shadow-primary/20 transition-all duration-300 hover:shadow-2xl hover:shadow-primary/30" onClick={() => window.location.href = '/api/login'}>
                      Join the Library
                    </Button>
