...
export default function Dashboard() {
  ...
  if (authLoading || loansLoading || holdsLoading) {
    return (
      <AppLayout>
    ...
    <AppLayout>
      <div className="bg-muted/20 border-b border-border/50 py-12">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          >
            <div>
              <h1 className="font-serif text-4xl font-bold text-foreground mb-2">Patron Dashboard</h1>
              <p className="text-lg text-muted-foreground">Welcome back, {user?.firstName || 'Reader'}. Here is your library activity.</p>
            </div>
